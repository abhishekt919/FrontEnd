...
const CountryCodeSelector = forwardRef(({ value, onChange }, ref) => {
    ...
    <div ref={ref}>
      ...
      >
        <Box
          ...
          sx={{
            background: "url('/assets/images/countries/flags.png') no-repeat 0 0",
      ...
      >
        {countries.map((item) => (
          ...
          >
            ...
            />
            <span className="ml-8 font-medium">{item.name} {item.code}</span>
          </MenuItem>
        ))}
      </Menu>
    </div>
