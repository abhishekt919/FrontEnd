                ...
                <DialogContent dividers>
                    <div className="grid grid-cols-1 gap-x-10 lg:gap-y-16  sm:grid-cols-2 lg:grid-cols-3 lg:gap-64 w-full my-0" >
                        ...
                        <div>
                            ...
                            <RecordStatus name={props.previewData.isVerified ? 'VERIFIED' : 'UNVERIFIED'} />
                        </div>
                    </div>
                                ...
                                <TableHead>
                                    <TableRow className="h-20">
                                        <TableCell className="p-16 pl-8">
                                            <Typography className="font-semibold">{t('LOCATION')} {t('ADDRESS')}</Typography>
                                        </TableCell>
                                        <TableCell className="p-16 pl-8">
                                            <Typography className="font-semibold">{t('CITY')}</Typography>
                                        </TableCell>
                                        <TableCell className="p-0">
                                            <Typography className="font-semibold">{t('STATE')}</Typography>
                                        </TableCell>
                                        <TableCell className="p-0">
                                            <Typography className="font-semibold">{t('COUNTRY')}</Typography>
                                        </TableCell>
                                        <TableCell className="p-0">
                                            <Typography className="font-semibold">{t('ZIPCODE')}</Typography>
                                        </TableCell>
                                        <TableCell className="p-0">
                                            <Typography className="font-semibold">{t('LAT')}/{t('LANG')}</Typography>
                                        </TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    <Fragment>
                                        <TableRow
                                            ...
                                            <TableCell className="pl-8 py-10" component="th" scope="row">{props.previewData?.locationAddress?.line1} {props.previewData?.locationAddress?.line2}</TableCell>
                                            <TableCell className="pl-8 py-10" component="th" scope="row">{props.previewData?.locationAddress?.city}</TableCell>
                                            <TableCell className="pl-8 py-10" component="th" scope="row">{props.previewData?.locationAddress?.state}</TableCell>
                                            <TableCell className="pl-8 py-10" component="th" scope="row">{props.previewData?.locationAddress?.country}</TableCell>
                                            <TableCell className="pl-8 py-10" component="th" scope="row">{props.previewData?.locationAddress?.zipcode}</TableCell>
                                            <TableCell className="p-0" component="th" scope="row">
                                                ...
                                                >
                                                    <Typography
                                                        ...
                                                        component={"a"}
                                                        onClick={() => window.open(`https://www.google.com/maps/place/${props.previewData?.locationAddress?.latitude},${props.previewData?.locationAddress?.longitude}`, '_blank')}
                                                    >
                                                        {props.previewData?.locationAddress?.latitude}, {props.previewData?.locationAddress?.longitude}
                                                    </Typography>
                                                </Tooltip>
                                            </TableCell>
                                        </TableRow>
