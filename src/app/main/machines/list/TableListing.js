        ...
        children: (
          <>
            <DialogTitle id="alert-dialog-title">
              {type} {item?.programSerialNumber}
            </DialogTitle>
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                {t("CONFIRM_WARNING")} {type} {item?.programSerialNumber} -{" "}
                {item?.company?.name} ?
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              ...
              <Button
                onClick={() => {
                  ...
                  dispatch(verifyMachine(inputJson)).then((result) => {
                    if (result.payload.messageId === 200) {
                      dispatch(
                        showMessage({ message: result.payload.message })
                      );
                      getData();
                    } else {
                      setLoading(false);
    ...
    <>
      ...
      <div className="flex items-center pl-14 py-8">
        ...
        <Link
          ...
          className={
            status === 2
              ? "mr-10 text-white bg-blue-800 rounded-full text-12 font-semibold py-4 px-12"
              : "mr-10"
          }
        >
          {t("ALL")}
              ...
              {_.orderBy(
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <CustomTooltip
                        title={n?.machineStatus ? t("ONLINE") : t("OFFLINE")}
                      >
                        <StyledBadge
                          overlap="circular"
                          anchorOrigin={{
                    ...
                    >
                      <RecordStatus
                        name={n.isVerified ? "VERIFIED" : "UNVERIFIED"}
                      />
                    </TableCell>
                    <TableCell
                        ...
                        <CustomActionMenu
                          actions={[
                            ...
                            },
                            {
                              ...
                              onClick: () =>
                                onVerifyMachine(n, t("VERIFY"), n.isVerified),
                            },
                            {
                              ...
                              isVisible: n.isVerified,
                              onClick: () =>
                                onVerifyMachine(n, t("UNVERIFY"), n.isVerified),
                            },
                          ]}
                        />
                      ) : (
